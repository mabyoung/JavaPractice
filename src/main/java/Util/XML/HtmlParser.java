...
public class HtmlParser {
    ...
    public static void main(String[] args) {
        ...
        Document doc = Jsoup.parse(readHtml("C:\\Users\\mabyo\\Desktop\\html1.xml"));
        // 获取html的标题
        ...
        // 获取ip
        Elements trs = doc.select("#wangrui").select("tbody").select("tr");
        for (Element tr : trs) {
            System.out.print("\'http\':\'http://");
            System.out.print(tr.select("td").get(0).text());
            System.out.print(":");
            System.out.print(tr.select("td").get(1).text());
            System.out.println("\',");
        }
    }
